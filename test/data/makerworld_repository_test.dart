  ...
  group('MakerWorldRepository', () {
    test('status decodes cloud token availability', () async {
      adapter.onGet(
        ...
        (s) => s.reply(200, {'has_cloud_token': true, 'can_download': true}),
      );
    ...
    test(
      'resolve decodes model design, instances and already imported ids',
      () async {
        adapter.onPost(
          ...
          data: {
            'url': 'https://makerworld.com/en/models/12345#profileId-67890',
          },
        );
    ...
    test(
      'import sends modelId, profileId, folderId and parses response',
      () async {
        adapter.onPost(
          ...
          data: {'model_id': 12345, 'profile_id': 67890, 'folder_id': 3},
        );
