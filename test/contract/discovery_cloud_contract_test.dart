...
void main() {
  group(
    'discovery, cloud and makerworld contract',
    skip: contractSkipReason,
    () {
      late Dio dio;
      ...
      test(
        'GET /cloud/builtin-filaments decodes into AmsFilamentPreset list',
        () async {
      ...
      test(
        'GET /firmware/updates decodes into FirmwareUpdatesResponse',
        () async {
