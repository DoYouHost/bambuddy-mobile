...
class HmsError {
  ...
  /// [fullCode] (`hms_errors.py::describe_fault`). **English only** — that table
  /// ships one language — so it is the fallback under the bundled localized
  /// catalogue, never above it (`HmsCatalog.describe`).
  ///
