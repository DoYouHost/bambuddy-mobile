...
ProjectListResponse _$ProjectListResponseFromJson(Map<String, dynamic> json) =>
    ProjectListResponse(
      ...
      targetCount: _toIntOrNull(json['target_count']),
      targetPartsCount: _toIntOrNull(json['target_parts_count']),
      budget: _toDoubleOrNull(json['budget']),
      createdAt: json['created_at'] as String?,
      archiveCount: json['archive_count'] == null
          ? 0
          : _toInt(json['archive_count']),
      totalItems: json['total_items'] == null ? 0 : _toInt(json['total_items']),
      completedCount: json['completed_count'] == null
          ? 0
          : _toInt(json['completed_count']),
      failedCount: json['failed_count'] == null
          ? 0
          : _toInt(json['failed_count']),
      queueCount: json['queue_count'] == null ? 0 : _toInt(json['queue_count']),
...
ProjectStats _$ProjectStatsFromJson(Map<String, dynamic> json) => ProjectStats(
  totalArchives: json['total_archives'] == null
      ? 0
      : _toInt(json['total_archives']),
  totalItems: json['total_items'] == null ? 0 : _toInt(json['total_items']),
  completedPrints: json['completed_prints'] == null
      ? 0
      : _toInt(json['completed_prints']),
  failedPrints: json['failed_prints'] == null
      ? 0
      : _toInt(json['failed_prints']),
  queuedPrints: json['queued_prints'] == null
      ? 0
      : _toInt(json['queued_prints']),
  inProgressPrints: json['in_progress_prints'] == null
      ? 0
      : _toInt(json['in_progress_prints']),
  totalPrintTimeHours: json['total_print_time_hours'] == null
      ? 0
      : _toDouble(json['total_print_time_hours']),
  totalFilamentGrams: json['total_filament_grams'] == null
      ? 0
      : _toDouble(json['total_filament_grams']),
  progressPercent: _toDoubleOrNull(json['progress_percent']),
  partsProgressPercent: _toDoubleOrNull(json['parts_progress_percent']),
  estimatedCost: json['estimated_cost'] == null
      ? 0
      : _toDouble(json['estimated_cost']),
  totalEnergyKwh: json['total_energy_kwh'] == null
      ? 0
      : _toDouble(json['total_energy_kwh']),
  totalEnergyCost: json['total_energy_cost'] == null
      ? 0
      : _toDouble(json['total_energy_cost']),
  remainingPrints: _toIntOrNull(json['remaining_prints']),
  remainingParts: _toIntOrNull(json['remaining_parts']),
  bomTotalItems: json['bom_total_items'] == null
      ? 0
      : _toInt(json['bom_total_items']),
  bomCompletedItems: json['bom_completed_items'] == null
      ? 0
      : _toInt(json['bom_completed_items']),
  bomCost: json['bom_cost'] == null ? 0 : _toDouble(json['bom_cost']),
);
...
BomItem _$BomItemFromJson(Map<String, dynamic> json) => BomItem(
  ...
  quantityNeeded: json['quantity_needed'] == null
      ? 1
      : _toInt(json['quantity_needed']),
  quantityAcquired: json['quantity_acquired'] == null
      ? 0
      : _toInt(json['quantity_acquired']),
  ...
  sortOrder: json['sort_order'] == null ? 0 : _toInt(json['sort_order']),
